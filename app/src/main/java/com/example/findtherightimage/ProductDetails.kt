...
class ProductDetails : AppCompatActivity(),PurchasesUpdatedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnMuaHang.setOnClickListener {
            startActivity(Intent(this@ProductDetails,ProductPackagePriceActivity::class.java))
            billingClient.startConnection(object : BillingClientStateListener {
                override fun onBillingSetupFinished(billingResult: BillingResult) {
                    if (billingResult.responseCode ==  BillingClient.BillingResponseCode.OK) {
                        ...
                        billingClient.queryProductDetailsAsync(queryProductDetailsParams) {
                            ...
                            for (i in listProductDetails.indices){
                                Log.d("TAG", "onBillingSetupFinished:  {${listProductDetails.get(i).oneTimePurchaseOfferDetails?.formattedPrice}}")
                    ...
                    val billingFlowParams = BillingFlowParams.newBuilder()
                        ...
                        .build()
                    val billingResult = billingClient.launchBillingFlow(this@ProductDetails, billingFlowParams)
                }
                        }
